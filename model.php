        ...
        <div class="modal-body">
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="duzina" placeholder="" required>
            </div>
            <div class="form-group">
              <label for="sirina">Širina:</label>
              <input type="text" class="form-control" id="sirina" placeholder="" required>
            </div>
  ...
  <div class='centerDiv'>
    ...
    <div class='middle_div grid-item'>
        ...
        <table class="table table-hover">
          <thead class="thead-dark">
            <tr>
              ...
              <th scope="col">Tip</th>
              <th scope="col">Dužina(cm)</th>
              <th scope="col">Širina(cm)</th>
            </tr>
          </thead>
          <tbody id='modeli'>
      ...
      <div class="alert alert-warning alert-dismissible fade show align_center" role="alert">
        <strong>Dodajte novi model!</strong> Naziv modela, tip i dužina su obavezni!
    ...
    $(document).ready(function () {
      $('#button_sacuvaj').click(function () {
        ...
        if (trenutniModelId == -1) {
          ...
          $.post('./server/izmeniModel.php', { id: trenutniModelId, naziv: naziv, tip: tip, duzina: duzina, sirina: sirina, marka: marka.id }, function (data) {
            vratiModele();
          })
        }
      ...
      $("#exampleModal").on('show.bs.modal', function (e) {
        ...
        if (trenutniModelId == -1) {
          ...
          $('#tip').val(model.tip);
          $('#duzina').val(model.duzina);
          $('#sirina').val(model.sirina);
        }
      })
